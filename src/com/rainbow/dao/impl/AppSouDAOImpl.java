...
public class AppSouDAOImpl implements AppSouDAO{
	...
	/**
	 * @author Administrator
	 *	如果两个文件名不相等并且不空的话说明上传了新的文件，则需要删除原来的文件
	 *	跟新数据库相应字段
	 */
	@Override
	public void update(int id, AppSource appSou) {
		...
		if(appSou.getGamePhoto1()!=null){
			if(tmp.getGamePhoto1()==null)
				...
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getGamePhoto1());
				file.delete();
				tmp.setGamePhoto1(appSou.getGamePhoto1());
			}
		}
		if(appSou.getGamePhoto2()!=null){
			if(tmp.getGamePhoto2()==null)
				...
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getGamePhoto2());
				file.delete();
				tmp.setGamePhoto2(appSou.getGamePhoto2());
			}
		}
		if(appSou.getGamePhoto3()!=null){
			if(tmp.getGamePhoto3()==null)
				...
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getGamePhoto3());
				file.delete();
				tmp.setGamePhoto3(appSou.getGamePhoto3());
			}
		}
		if(appSou.getGamePhoto4()!=null){
			if(tmp.getGamePhoto4()==null)
				...
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getGamePhoto4());
				file.delete();
				tmp.setGamePhoto4(appSou.getGamePhoto4());
			}
		}
		if(appSou.getGamePhoto5()!=null){
			if(tmp.getGamePhoto5()==null)
				...
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getGamePhoto5());
				file.delete();
				tmp.setGamePhoto5(appSou.getGamePhoto5());
			}
		}
		if(appSou.getLogo1()!=null){
			if(tmp.getLogo1()==null)
				...
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getLogo1());
				file.delete();
				tmp.setLogo1(appSou.getLogo1());
			}
		}
		if(appSou.getLogo2()!=null){
			if(tmp.getLogo2()==null)
				...
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getLogo2());
				file.delete();
				tmp.setLogo2(appSou.getLogo2());
			}
		}
		if(appSou.getPackge()!=null){
			...
			else if(!tmp.getPackge().equals(appSou.getPackge())){
				File file = new File(ServletActionContext.getServletContext().getRealPath("")+tmp.getPackge());
				file.delete();
				tmp.setPackge(appSou.getPackge());
			}
		}
