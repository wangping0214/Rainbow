...
<div class="content">
     <div class="search">
      ...
      <div class="midcont">
             <div class="tit">
                 <p class="headnav">填写应用信息</p>
             </div>
             <!--tit-->
             <form id="form1" name="form1" method="post" action="">
             <div class="tit2">基本信息</div>
             <div class="cont">
                 <div class="xinxicont">
                     <div><label>应用名称:</label><p class="pp"><input name="textfield2" type="text" class="inputs" /><span class="hint wrong">应用名称不能为空</span><p class="zhushi">建议您与应用包中的名称一致。</p></p></div>
                     <div><label>类型:</label>
                         <p class="pp">
                              <select name="select">
                                  <option>游戏</option>
                      ...
                      <div><label>分类:</label>
                           <p class="pp">
                            ...
                            <p class="pp">
                             ...
                             <span class="hint wrong">应用名称不能为空</span>
                       </div>
                       <div><label>语言:</label>
                           <p class="pp">
                       ...
                       <div><label class="zifei">简介:</label>
                           <p class="pp pp2">
                               ...
                               <span class="hint wrong">填写一句话简介</span>
             ...
             <div class="cont">
                 <div class="xinxicont">
                      <div><label>应用安装包:</label>
                         <p class="pp">
                           <input name="textfield2" type="text" class="inputs2" /><input type="file"  name="browse" style="display:none;"  /><a href="javascript:fn_browse();" title="上传"> <img name="btn" src="images/liulan.jpg" width="60" height="30" border="0" style="vertical-align:top"/></a><span class="hint right"> </span><span class="hint wrong">填写一句话简介</span><p class="zhushi">请上传您的应用。</p></p></div>
                      <div><label>应用图标:</label>
                       ...
                       <div class="matter"><label>游戏图片素材:</label>
                           <div><p class="pp"><input type="file"  name="browse2" style="display:none;"  /><a href="javascript:fn_browse();" title="截图"> <img name="btn" src="images/icon2.jpg"  border="0" style="vertical-align:middle"/></a><a href="#" class="guan"><img src="images/guan.png" /></a><span class="hint wrong">请上传图片</span></p><p class="pp"><input type="file"  name="browse2" style="display:none;"  /><a href="javascript:fn_browse();" title="截图"> <img name="btn" src="images/icon2.jpg"  border="0" style="vertical-align:middle"/></a></p><p class="pp"><input type="file"  name="browse2" style="display:none;"  /><a href="javascript:fn_browse();" title="截图"> <img name="btn" src="images/icon2.jpg"  border="0" style="vertical-align:middle"/></a></p><p class="pp"><input type="file"  name="browse2" style="display:none;"  /><a href="javascript:fn_browse();" title="截图"> <img name="btn" src="images/icon2.jpg"  border="0" style="vertical-align:middle"/></a></p><p class="pp"><input type="file"  name="browse2" style="display:none;"  /><a href="javascript:fn_browse();" title="截图"> <img name="btn" src="images/icon2.jpg"  border="0" style="vertical-align:middle"/></a></p> </div>
