...
<!--nav2-->
<div class="middle">
   <div class="position"><a href="#">安卓游戏分类</a>><a href="#">角色扮演</a>><a href="#">进击的部落</a></div>
   <div class="xcont">
      <div class="xcontleft">
         <div class="gamecont">
             <dl>
                 <dt>
                     <p class="suolve"><a href="#"><img src="images/b1.png" width="94" height="94" /></a></p>
                     <p class="xia3"><a href="#">下载</a></p>
                 </dt>
                 <dd class="gametit"><span>进击的部落</span><p><img src="images/wd.jpg" /><img src="images/wgg.jpg" /><img src="images/ys.jpg" /><img src="images/gf.jpg" /></p></dd>
                 <dd><span>下　载：75万次</span><span>大　小：40M</span></dd>
                 <dd><span>资　费：免费游戏</span><span>分　类：网络游戏</span></dd>
                 <dd><span>语　言：中文</span><span>版　本：1.3.0</span></dd>
                 <dd><span>时　间：2014-05-28</span></dd>
                 <dd>开发者：深圳市微讯移通信息技术有限公司</dd>
             </dl>
         </div>
         <!--gamecont-->
         ...
         <div class="gameimg">
             <div class="carousel">
		        ...
		        <div class="jCarouselLite" id="demo-03">
			        <ul>
				       <li><img src="images/d1.jpg" width="246" height="409"/></li>
				       <li><img src="images/d2.jpg" width="246" height="409"/></li>
                       <li><img src="images/d3.jpg" width="246" height="409"/></li>
                       <li><img src="images/d4.jpg" width="246" height="409"/></li>
			        </ul>
		      </div>
                ...
                <dl id="select-brand">
                  ...
                  <dd>
                     <div class="content" style="height:88px;">
                        <p>《进击的部落》继席卷2013安卓手游榜之后，最受玩家期待全新版本【天下第一】震撼上线！众神齐聚，巅峰对决；真假造物神兵降世，傲视天下群雄；跨服争霸--集龙珠召唤神龙，更多新鲜元素给你带来全新的游戏体验， 让人爱不释手的SLG+RPG网游巅峰巨作！快来炸鸡配啤酒，与《进击的部落》开怀整个夏天！<br />*三大职业，四大兵种，挑战暗黑魔法势力。<br />
*百种副本关卡，多种魔幻神兽，上演PK决战。<br />
*百变阵型组合，超炫技能排列，体验策略精髓所在。<br />
*Q版写实风，让你感受远古建筑和魔幻神兽带来的神秘意境！</p> 
                      </div>
                ...
                <dl id="select-brand1">
                  ...
                  <dd>
                     <div class="content" style="height:88px;">
                       <p>★ 跨服竞技，谁是天下第一。每周五、周六跨服竞技，巅峰战队对决，踏上属于你的王者之路。还有丰厚的奖励等你领取。<br />
★ 未参战的玩家同样可以参与跨服战，为你喜爱的战队投注，同时本服务器战队所获得的名次，本服务器所有在线玩家将会获得相应奖励。<br />
★ 集龙珠，召神龙，许美愿。游戏推出龙珠系统，消耗一定资源，获得所消耗资源X倍的资源返还<br />
★ 新版造物主武器全新登场，更少碎片，图纸易得，还能可以升级进化。<br />
★ 小伙伴们还在为在竞技场中找不到对手而寂寞么？新版本玩家可以在直接在连胜排行榜中挑战排行榜上的玩家<br />
★ 新手引导优化，游戏体验提升<br />
</p> 
                    </div>
...
<script type="text/javascript">
(function() { var b = $("#select-brand .tab"), f = $("#select-brand .content"), h = $("#select-hold"), c = b.find(".curr").attr("rel"), g = "54px", a; var d = 0, i = 0, e = (screen.width >= 800) ? 1: 1; i = Math.ceil(f.children().size() / e); d = (f.children().outerHeight()) ; if (d > parseInt(g)) { f.css("height", g); h.html("<b></b>展开").attr("class", "close") } else { h.html("<b></b>收起").attr("class", "open") } h.bind("click", function() { if ($(this).attr("class") != "open") { f.css("height", "auto");jsptml("<b></b>收起").attr("class", "open") } else { f.css("height", g); h.html("<b></b>展开").attr("class", "close") } }); b.find("li").bind("mouseover", function() { var j = $(this); a = setTimeout(function() { if (j.attr("rel") == c) { return } b.find("li").eq(c).removeClass("curr"); j.addClass("curr"); c = j.attr("rel"); f.css("height", "auto"); h.hide(); f.find("div").each(function() { if (c == 0) { $(this).show() } else { $(this).hide(); if ($(this).attr("rel") == c) { $(this).show() } } }) }, 500) }).bind("mouseout", function() { clearTimeout(a) }) })();
</script>
<script type="text/javascript">
