...
<div class="middle">
   ...
   <div class="mycont">
      <div class="myleft">
          ...
          <!--person-->
          <div class="lovegame">
                 <div class="lovetit lovetit3"><p class="fl"><img src="images/pd_03.jpg" />我下载过的应用...</p><div class="search3"><input type="text" value="" class="text3" /><input type="button" value="" class="searbut"/></div></div>
                 <div class="lovelist lovelist3">
                     <dl>
                        <dt><a href="#"><img src="images/s_03.jpg" /></a></dt>
                        <dd><a href="#">兄贵草泥马</a></dd>
                        <dd class="leixing"><a href="#">休闲益智</a></dd>
                        <dd><a href="#"><img src="images/pd_11.jpg" /></a></dd>
                        <dd class="close2"><a href="#"><img src="images/pd_15.jpg" /></a></dd>
                     </dl>
                     <dl>
                        <dt><a href="#"><img src="images/s_03.jpg" /></a></dt>
                        <dd><a href="#">兄贵草泥马</a></dd>
