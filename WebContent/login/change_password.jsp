...
$(function()
{
	...
	$(".bg_arr").click(function ()
	{
		...
		if(num == 1)
		{
			$("html, body").stop().animate({scrollTop:$(".card").offset().top-50}, {easing:"easeInOutCubic"});
		}
		else 
		{
			$("html, body").stop().animate({scrollTop:$(".theme").offset().top-50}, {easing:"easeInOutCubic"});
		}
		if(num == 3)
		{
			$("html, body").stop().animate({scrollTop:$(".theme2").offset().top-50}, {easing:"easeInOutCubic"});
		}
...
<body>
   <div id="wrap">
        <div id="header">
            <div class="nav">
                ...
                <div class="fr navright">
                    ...
                    <div class="search fl"><input type="text" value="搜索安卓软件和游戏"  class="type"/><input type="button" value="" class="sou" /></div>
                </div>
                <!--navright-->
            </div>
            <!--nav-->
        ...
        <!--header-->
       <div><img src="images/im_05.jpg" width="950" /></div>
       <div class="im1">
       ...
       <div class="im2"> 
           ...
           <span  idx="1"  class="bg_arr"><img  src="images/im1.png"  alt=""></span>
            <div class="lunbo1">
                   <div class="picList">
                      <div class="big">
                          <a href="#"><img src="images/big1.jpg" /></a>
                          <a href="#"><img src="images/big1.jpg" /></a>
                          <a href="#"><img src="images/pic_three_big.jpg" /></a>
                          <a href="#"><img src="images/pic_four_big.jpg"/></a>
                          <a href="#"><img src="images/big1.jpg" /></a>
                          <a href="#"><img src="images/pic_three_big.jpg" /></a>
                          <a href="#"><img src="images/pic_four_big.jpg" /></a>
                      </div>
                     <ul class="smallList">
                        <li><img src="images/im2_06.jpg" width="52" height="72" /><div class="redLine"></div></li>
                        <li><img src="images/im2_08.jpg" /></li>
                        <li><img src="images/im2_10.jpg" /></li>
                        <li><img src="images/im2_12.jpg" /></li>
                        <li><img src="images/im2_15.jpg" /></li>
                        <li><img src="images/im2_17.jpg" /></li>
                        <li><img src="images/im2_19.jpg" /></li>
                     </ul> 
                     <div class="clear"></div>
                  </div>
                  <!--picList-->
       ...
       <div class="im3">
          <div class="cont theme bg1">
             ...
             <p class="join"><a href="today_recommend.jsp"><img src="images/join_03.jpg" /></a></p>
...
游戏都经过真机适配测试，让用户玩得放心开心。</p>
                                <p><a href="today_recommend.jsp"><img src="images/m_07.jpg" /></a></p>
                            </div>	
							<div  class="theme_tit">
