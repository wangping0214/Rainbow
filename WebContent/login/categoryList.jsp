...
<div class="middle">
   ...
   <s:if test="#request.category<8"><a href="game_class.jsp">>安卓游戏分类</a></s:if><s:else><a href="software_cat.jsp">>安卓软件分类</a></s:else>
   ...
   <div class="allclass">
       <ul class="classnav">
		<s:set name="clf" value="#request.clf"/>
           <li><a href="webShowByCategory.action?appTmp.showByCategoryCurrentPage=1&category=<s:property value="#request.category" />">全部</a></li>
       ...
       <s:iterator value="#request['app']" id="app">
           <div class="one">
               <dl>
                  ...
                  <a href="downApk.action?bowser=<%=bowser %>&appSouId=<s:property value="#app.appSou.id" />&downPath=<s:property value="#app.appSou.packge" escape='false'/>" id="id_downLoad" class="xia2">下载</a></dd>
                  <dd>下载：<s:property value="#app.appAut.amountOfDown" />次   大小:<s:property value="#app.appSou.packgeSize" />M</dd>
               </dl>
