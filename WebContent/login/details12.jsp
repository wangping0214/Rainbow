...
<!--nav2-->
<div class="middle">
   <div class="position"><a href="#">安卓游戏分类</a>><a href="#">角色扮演</a>><a href="#"></a>激情牛牛</div>
   <div class="xcont">
      <div class="xcontleft">
         <div class="gamecont">
             <dl>
                 <dt>
                     <p class="suolve"><a href="#"><img src="images/b12.png" width="94" height="94" /></a></p>
                     <p class="xia3"><a href="#">下载</a></p>
                 </dt>
                 <dd class="gametit"><span>激情牛牛</span>
                   <p><img src="images/wd.jpg" /><img src="images/wgg.jpg" /><img src="images/ys.jpg" /><img src="images/gf.jpg" /></p></dd>
                 <dd><span>下　载：35万次</span><span>大　小：4.81M</span></dd>
                 <dd><span>资　费：道具收费</span><span>分　类：棋牌休闲</span></dd>
                 <dd><span>语　言：中文</span><span>版　本：2.0.2</span></dd>
         ...
         <div class="gameimg">
             <div class="carousel">
		        ...
		        <div class="jCarouselLite" id="demo-03">
			        <ul>
				       <li><img src="images/d45.jpg" width="246" height="409"/></li>
				       <li><img src="images/d46.jpg" width="246" height="409"/></li>
                       <li><img src="images/d47.jpg" width="246" height="409"/></li>
                       <li><img src="images/d48.jpg" width="246" height="409"/></li>
			        </ul>
		      </div>
                ...
                <dl id="select-brand">
                  ...
                  <dd>
                     <div class="content" style="height:88px;">
                        <p>
畅游棋牌，激情斗牛！《激情牛牛》是激情牛牛研发团队研发的一款新型斗牛游戏，游戏拥有独特华丽的星空界面，打破千篇一律的卡通风格；集当下最热的美女元素，给你带来最养眼的视觉体验；便捷的操作体验让你不用外出即可感受异国风情与智慧斗牛的快感。其既沿袭了传统的牛牛游戏规则，又加入了技能牌、开心牌、资产大比拼等热门元素，更增设娱乐场、兑奖系统，一定能为广大玩家提供更好的游戏体验！激情牛牛研发团队将为广大玩家在现在同质化严重的牛牛游戏环境里一个惊喜。<br />
◆画面精美<br />
◆高端洋气上档次的页面风格，低调奢华有内涵的画面享受<br />
◆操作便捷流畅<br />
◆为Android系统量身打造，体验至尊游戏的快乐！<br />
◆游戏全天开放，24小时不间断！起来体验泡泡吧！
                        </p> 
                    </div>
                ...
                <dl id="select-brand1">
                  ...
                  <dd>
                     <div class="content" style="height:88px;">
                       <p>1.修正用户赠送元宝bug<br />2.修正娱乐场算法<br /></p> 
                    </div>
