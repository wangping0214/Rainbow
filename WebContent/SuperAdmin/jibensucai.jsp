                  ...
                  <div class="list">
                      ...
                      <div class="xinxicont">
                         <form id="form1" name="form1" method="post" action="auditSou.action">
                               ...
                               <input name="subApp.appSou.packge" height="30" type="text" size="40" id="id_tx_packge" readonly/>
                               <input type="file" name="appTmp.packgeContent" style="display:none;" id="id_packge" onchange="id_tx_packge.value=this.value"/>
                               <%}
                               else{%>
                               <input name="subApp.appSou.packge" height="30" type="text" size="40" id="id_tx_packge" value=<%=appSou.getPackge() %> readonly/>
                               <input type="file" name="appTmp.packgeContent" style="display:none;" id="id_packge"  onchange="id_tx_packge.value=this.value"/>
                               <%} %>
                               <a href="<%=request.getContextPath()+appSou.getPackge() %>" class="scyy" >导出</a>
                               </p>
                               ...
                               <input name="subApp.appSou.logo1" height="30" type="text" size="40" id="id_tx_logo1" readonly/>
                               <%}
                               else{%>
                               <input name="subApp.appSou.logo1" height="30" type="text" size="40" id="id_tx_logo1" value=<%=appSou.getLogo1() %> readonly/>
                               <%} %>
                               <input type="file"  name="appTmp.logo1Content" style="display:none;" id="id_logo1" onchange="id_tx_logo1.value=this.value" />
                               <a href="<%=request.getContextPath()+appSou.getLogo1() %>" class="scyy" >导出</a></p>
                               <p class="zhushi">尺寸72px*72px，png格式，圆角 ，具体请参考<a href="#" class="bluea"> Logo样本</a>
</p>
                               </div>
                               <div><label>logo图标(512*512):</label><p class="pp">
                               <%if(appSou.getLogo2()==null){ %>
                               <input name="subApp.appSou.logo2" height="30" type="text" size="40" id="id_tx_logo2" readonly/>
                               <%}
                               else{%>
                               <input name="subApp.appSou.logo2" height="30" type="text" size="40" id="id_tx_logo2" value=<%=appSou.getLogo2() %> readonly/>
                               <%} %>
                               <input type="file"  name="appTmp.logo2Content" style="display:none;" id="id_logo2" onchange="id_tx_logo2.value=this.value" />
                               <a href="<%=request.getContextPath()+appSou.getLogo2() %>" class="scyy" >导出</a></p>
...
<a href="#" class="bluea"> Logo样本</a>
                               ...
                               <div style="clear:both; overflow:hidden; zoom:1;"><label>游戏图片素材:</label><div class="sclogo">
                                   <div class="logoimg">
                                          ...
                                          <a href="<%=request.getContextPath()+appSou.getGamePhoto1() %>">
                                          ...
                                          <a href="<%=request.getContextPath()+appSou.getGamePhoto2() %>">
                                          ...
                                          <a href="<%=request.getContextPath()+appSou.getGamePhoto3() %>">
                                          ...
                                          <a href="<%=request.getContextPath()+appSou.getGamePhoto4() %>">
                                          ...
                                          <a href="<%=request.getContextPath()+appSou.getGamePhoto5() %>"><img name="btn" src="<%=request.getContextPath()+appSou.getGamePhoto5() %>"  width="81" height="71" border="0" style="vertical-align:middle" id="photo5"/></a>
                                          <%} %>
                          ...
                          <div class="uppage"><a href="jibenxinxi.jsp" target="main">上一页</a><a href="rank.action?appTmp.rankCurrentPage=0" target="main">返回</a></div>
                      </div>
                      <!--dailist-->
