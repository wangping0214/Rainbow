...
$(document).ready(function() {    
  ...
  <body>      
    >>>>>><span style="color:red"><%=session.getAttribute("appName") %>下架</span>>>>>>页面将在<span id="num">3</span>秒  跳转不成功<a href="isShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=-1">点击这里</a>>>>>>>>>>
