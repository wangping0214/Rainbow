...
<script type="text/javascript" language="javascript">
	$(document).ready(function() {
		$("#app_select_id").change(function() {
			window.open("adminSearchByAppName?appName="+$("#app_select_id").val(),"reportSearchResult");
		});
		...
		$("#orderOrAppName").click(function(){
			window.open("adminSearchByOrderOrAppName?orderIdOrAppName="+$("#orderIdOrAppName").val(),"reportSearchResult")
		});
	});
	function showAppReportDetail(appId){
		window.open("adminShowAppReportDetail?appId="+appId,"reportSearchResult")
	}
</script>
</head>
			...
			<div class="midcont">
				<div class="list">
					<ul class="guanggaonav">
						<li><a href="adminReportInit" target="main">企业订单</a>></li>
						<li><%if(user.getCorporatename()!=null){ %>
