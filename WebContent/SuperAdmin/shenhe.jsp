...
<div class="content">
  ...
  <s:iterator value="#request['app']" id="app">
	<div class="b3">
	     <p><a href="guanlishenhe.jsp" target="main"><img src="<%=request.getContextPath() %><s:property value="#app.logo1"/>" width="80" height="80" /></a></p>
		 <p><a href="guanlishenhe.jsp" target="main"><s:property value="#app.appName"/></a></p>
	</div>
	</s:iterator>
    <ul class="page">
