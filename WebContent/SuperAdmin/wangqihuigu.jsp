...
<div class="content" style="height:620px;">
     ...
     <div class="midcont">
                   <div class="list wqlist">
                      <h3 class="tit4"><select><option>2014年</option><option>2013年</option></select></h3>
                      <div class="dailist wangqi">
                         <dl>
                            <dt><a href="#">第六期</a></dt>
                            <dd><a href="#"><img src="images/img10.png" /></a></dd>
                            <dd class="but2"><a href="#"></a><input type="submit" value="" /><input type="submit" value="" /></dd>
                         </dl>
                         <dl>
                            <dt><a href="#">第五期</a></dt>
                            <dd><a href="#"><img src="images/img10.png" /></a></dd>
