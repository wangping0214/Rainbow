...
.touxiang span{ height:52px; line-height:52px; float:left; font-family:"微软雅黑"; font-weight:normal; font-size:20px; color:#768593;}
...
.nav4{ background:url(images/img6s.png) no-repeat;_background:url(images/img6s.gif) no-repeat;display:block; width:138px; height:39px; line-height:39px; text-align:center;}
...
<ul id="menu">
 <li class="item"><a href="javascript:void(0)" class="title nav1" name="1">杂志</a>
   <ul id="opt_1" class="optiton">
    <li><a href="wangqi.jsp" target="main"><img src="images/k.gif" class="pngf" />杂志列表</a></li>
    <li><a href="xinqi.jsp" target="main"><img src="images/img17.gif" class="pngf" />期刊编辑</a></li>

   </ul>
 </li>
  <li class="item"><a href="menuAdminSelfAppAndGame.action?userName=<%=session.getAttribute("username") %>" class="title nav4" name="2" target="menu">应用&amp;游戏</a>
   <ul id="opt_2" class="optiton">
    <li><a href="isShelf.action?appTmp.isShelfCurrentPage=1" target="main"><img src="images/img16.gif" />管理游戏&amp;应用</a></li>
  ...
  <li class="item"><a href="menuAdminAppAndGame.action" class="title nav2" name="3" target="menu">应&amp;游管理</a>
   <ul id="opt_3" class="optiton">
   <li><a href="adminShowAllJoint.action?currentPage=1&shelf=1&joint=1" target="main"><img src="images/lianyun.gif" />联运应用管理</a></li>
    <li><a href="adminIsShelf.action?appTmp.isShelfCurrentPage=1" target="main"><img src="images/img16.gif" />全部应用</a></li>
    <li class="gl"><a href="adminIsThrough.action?appTmp.isThrough=0" target="main"><img src="images/img18.gif"/>审批处理</a><p class="dainum"><%=session.getAttribute("adminTotal") %></p></li>
    <li><a href="rank.action?appTmp.rankCurrentPage=1" target="main"><img src="images/img19.gif"/>排序调整</a></li>
   </ul>
 </li>


 <li class="item"><a href="guanggaogl.jsp" target="main" class="title nav3" name="4">其他</a>
   <ul id="opt_4" class="optiton">
	<li><a href="guanggaogl.jsp" target="main"><img src="images/img28.gif" />广告管理</a></li>
    ...
    <li><a href="adminReportInit" target="main"><img src="images/img29.gif" />账单查询</a></li>
   </ul>
 </li>
</ul>
