...
.twobut{ background:url(images/yis.png) no-repeat; width:100px; height:30px; margin-top:5px;}
...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         <li class="red"><a href="adminIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=1" target="main">已上架</a></li>
  ...
  <s:iterator value="#request['app']" id="app">
    ...
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="adminIsShelf.action?appTmp.isShelfCurrentPage=5&appTmp.isShelf=1">5</a></li>
       </s:if>
