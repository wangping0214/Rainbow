                  ...
                  <div class="list">
                      ...
                      <div class="guanggaocont">
                          <div class="huiyuancont">
                              <div class="tit7"><b>企业用户:</b><span class="green"><%=session.getAttribute("corporatename") %></span></div>
								<form id="form1" name="form1" method="post" action="reg_approved.action" enctype="multipart/form-data">
                                  <div class="form4">
                                     ...
                                     <div><input type="radio" value="no_ok"name="radioselect"/>未通过前方打钩
                                     <textarea class="weliyou">未通过理由</textarea>
                                     </div>
                                  </div>
                                  <!--form2-->
                                  <div class="back back2"><a href="<%=request.getContextPath()%>/SuperAdmin/chulishenpi.jsp" target="main">上一步</a>
