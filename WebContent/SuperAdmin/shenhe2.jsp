...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         <li class="red"><a href="waitshenhe2.jsp" target="main">等待审核</a></li>
         <li><a href="weitongguosh2.jsp" target="main">未通过审核</a></li>
      </ul>
  <div class="b2">
	<div class="b3">
	     <p><a href="guanlishenhe2.jsp" target="main"><img src="images/img21.png" width="80" height="80" /></a></p>
		 <p><a href="guanlishenhe2.jsp" target="main"> 捕鱼达人</a></p>
	</div>
    <div class="b3">
	     <p><a href="guanlishenhe2.jsp" target="main"><img src="images/img21.png" width="80" height="80" /></a></p>
		 <p><a href="guanlishenhe2.jsp" target="main"> 捕鱼达人</a></p>
