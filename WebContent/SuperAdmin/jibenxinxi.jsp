     ...
     <div class="midcont">                  
                  <div class="list">
                      ...
                      <div class="xinxicont">
                          <form id="form1" name="form1" method="post" action="auditInfo.action" enctype="multipart/form-data">
                              ...
                              <div><label>安全防范:</label>
                                 ...
                                 <%if(info.getSecurity()==null){ %>
                                    <select name="appTmp.adv">
                                    <option value="0">无广告</option><option value="1">有广告</option>
                                    </select>
                                    <select name="appTmp.vir">
                                    <option value="0">无病毒</option><option value="1">有病毒</option>
                                    </select>
                                    <select name="appTmp.pri">
                                    <option value="0">隐私</option><option value="1">无隐私</option>
                                    </select>
                                    <select name="appTmp.off">
                                    <option value="0">官方版</option><option value="1">非官方</option>
                                    </select>
                                    <%}
                                 else {
                                 %>
                                 <%if(info.getSecurity().charAt(0)=='0'){ %>
                                 	<select name="appTmp.adv">
                                    <option value="0" selected="selected">无广告</option><option value="1">有广告</option>
                                    </select>
                                 <%}
                                 else{%>
                                 	<select name="appTmp.adv">
                                    <option value="0">无广告</option><option value="1" selected="selected">有广告</option>
                                    </select>
                                 <%} 
                                 if(info.getSecurity().charAt(2)=='0'){
                                 %>
                                	<select name="appTmp.vir">
                                    <option value="0" selected="selected">无病毒</option><option value="1">有病毒</option>
                                    </select>
                                 <%}
                                 else{%>
                                 	<select name="appTmp.vir">
                                    <option value="0">无病毒</option><option value="1" selected="selected">有病毒</option>
                                    </select>
                                 <%}
                                 if(info.getSecurity().charAt(4)=='0'){%>
                                 	<select name="appTmp.pri">
                                    <option value="0" selected="selected">隐私</option><option value="1">无隐私</option>
                                    </select>
                                    <%}
                                 else{%>
                                 	<select name="appTmp.pri">
                                    <option value="0" >隐私</option><option value="1" selected="selected">无隐私</option>
                                    </select>
                                 <%}
                                 if(info.getSecurity().charAt(6)=='0'){%>
                                 	<select name="appTmp.off">
                                    <option value="0" selected="selected">官方版</option><option value="1">非官方</option>
                                    </select>
                                 <%}
                                 else{%>
                                 	<select name="appTmp.off">
                                    <option value="0">官方版</option><option value="1" selected="selected">非官方</option>
                                    </select>
                                 <%}
                                 } %>
                                 </p>
                          ...
                          <div class="uppage"><a href="rank.action?appTmp.rankCurrentPage=0" target="main">返回</a><a href="jibensucai.jsp" target="main">下一页</a>
                      </div>
                      <!--dailist-->
