...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         ...
         <li class="red"><a href="adminShowAllJoint.action?currentPage=1&shelf=-2&joint=1" target="main">强制下架</a></li>
      </ul>
   <div class="b2">
   <s:iterator value="#request['app']" id="app">
    ...
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="adminShowAllJoint.action?currentPage=1&shelf=-2&joint=1">首页</a>
		</li>
		</s:if>
       <s:if test="#page.hasPrevious">
       <li><a href="adminShowAllJoint.action?currentPage=<s:property value="#page.currentPage-1"/>&shelf=-2&joint=1">上一页</a>
		</li>
		</s:if>
		<s:if test="#page.totalPage>1">
       <li><a href="adminShowAllJoint.action?currentPage=1&shelf=-2&joint=1">1</a></li>
       </s:if>
       <s:if test="#page.totalPage>2">
       <li><a href="adminShowAllJoint.action?currentPage=2&shelf=-2&joint=1">2</a></li>
        </s:if>
        <s:if test="#page.totalPage>3">
       <li><a href="adminShowAllJoint.action?currentPage=3&shelf=-2&joint=1">3</a></li>
        </s:if>
        <s:if test="#page.totalPage>4">
       <li><a href="adminShowAllJoint.action?currentPage=4&shelf=-2&joint=1">4</a></li>
       </s:if>
       <s:if test="#page.totalPage>5">
       <li><a href="adminShowAllJoint.action?currentPage=5&shelf=-2&joint=1">5</a></li>
       </s:if>
       <s:if test="#page.hasNext">
       <li><a href="adminShowAllJoint.action?currentPage=<s:property value="#page.currentPage+1"/>&shelf=-2&joint=1">下一页</a></li>
       </s:if>
       <s:if test="#page.hasLast">
		<li><a href="adminShowAllJoint.action?currentPage=<s:property value="#page.totalPage"/>&shelf=-2&joint=1">尾页</a></li>
		</s:if>
