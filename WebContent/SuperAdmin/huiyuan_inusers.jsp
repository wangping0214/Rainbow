                          ...
                          <div class="huiyuancont">
                              <div class="tit6">
                                 <select id="select"name="seusertype">
                                      ...
                                      <option value="individualUsers"selected="selected">个人开发者</option>
                             ...
                             <div class="yonghu">
                              <table border="0" cellpadding="0" cellspacing="0" width="98%" class="table1">
                                   ...
                                   <tr>
                                       <td class="name"><s:property value="#member.realname"/></td>
                                       <td><s:property value="#member.nowtime"/></td>
                                       <td>已上传：[<a href="allyingyong.jsp" target="main" class="green">10</a>]</td>
                                       ...
                                       <td align="center"><a href="<%=request.getContextPath()%>/information.action?memusername=<s:property value="#member.username"/>&memusertype=<s:property value="#member.userType"/>" target="main" class="xinxi">个人信息</a></td>
                                   </tr>
                                   </s:iterator>
                              </table>
                              <ul class="page">
                              ...
                              <li><a href="mem_manager.action?isCurrentPage=1&isuserType=individualUsers">首页</a>
                              </li>
                              </s:if>
                              <s:if test="#page.hasPrevious">
                              <li><a href="mem_manager.action?isCurrentPage=<s:property 

                              value="#page.currentPage-1"/>&isuserType=individualUsers">上一页</a>
                              </li>
		                      </s:if>
		                      <s:if test="#page.totalPage>1">
                             <li><a href="mem_manager.action?isCurrentPagee=1&isuserType=individualUsers">1</a></li>
                             </s:if>
                             <s:if test="#page.totalPage>2">
                             <li><a href="mem_manager.action?isCurrentPage=2&isuserType=individualUsers">2</a></li>
                              </s:if>
                              <s:if test="#page.totalPage>3">
                             <li><a href="mem_manager.action?isCurrentPage=3&isuserType=individualUsers">3</a></li>
                              </s:if>
                              <s:if test="#page.totalPage>4">
                             <li><a href="mem_manager.action?isCurrentPage=4&isuserType=individualUsers">4</a></li>
                             </s:if>
                             <s:if test="#page.totalPage>5">
                             <li><a href="mem_manager.action?isCurrentPage=5&isuserType=individualUsers">5</a></li>
                             </s:if>
                             <s:if test="#page.hasNext">
                             <li><a href="mem_manager.action?isCurrentPage=<s:property 

                             value="#page.currentPage+1"/>&isuserType=individualUsers">下一页</a></li>
                             </s:if>
                             <s:if test="#page.hasLast">
	                      	<li><a href="mem_manager.action?isCurrentPage=<s:property 

                      value="#page.totalPage"/>&isuserType=individualUsers">尾页</a></li>
		                      </s:if>
