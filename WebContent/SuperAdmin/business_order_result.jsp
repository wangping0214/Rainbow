...
<%
	List<UserApps> userAppsList = (List<UserApps>) session
			.getAttribute("userAppsList");
...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="700"
		...
		<%for(UserApps userApps : userAppsList){ %>
			<tr>
				<td class="name" width="25%"><%=userApps.getUser().getCorporatename() %></td>
				<td width="20%"><%=userApps.getApp().size() %></td>
				<td width="18%"><%=userApps.getReceiptList().size() %></td>
				<td width="20%"><%=userApps.getPaySum() %></td>
				<td width="15%"><a href="order_form.html" class="mingxi">查看明细</a></td>
			</tr>
			<%} %>
	</table>
</body>
