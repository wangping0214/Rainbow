...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         ...
         <li><a href="isShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=0" target="main">待发布</a></li>
         <li class="red"><a href="isShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=-1" target="main">已下架</a></li>
      </ul>
    <div class="b2">  
  <s:iterator value="#request['app']" id="app">
	<div class="b3">
		 ...
		 <div class="twobut">
             ...
             <a href="javascript:if(confirm('确认删除<s:property value="#app.appInfo.appName" />'))window.location='userDeleteApp.action?appTmp.deleteAppId=<s:property value="#app.appInfo.id"/>'" title="删除"></a>
		  </div>
	</div>
	</s:iterator>
    </div>
