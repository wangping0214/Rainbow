...
function setIsShelf(name,id){
	if(window.confirm("将"+name+"上架？")){
		location.href="devSetIsShelf.action?appTmp.setIsShelfId="+id;
	}
}
</script>
</head>
...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=1" target="main">已上架</a></li>
         <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=0" target="main">待发布</a></li>
         <li class="red"><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=-1" target="main">已下架</a></li>
      </ul>
    <div class="b2">  
...
<s:property value="#app.appInfo.appName" />
		 ...
		 <div class="twobut">
             ...
             <a href="javascript:if(confirm('确认删除<s:property value="#app.appInfo.appName" />'))window.location='devDeleteApp.action?appTmp.deleteAppId=<s:property value="#app.appInfo.id"/>'" title="删除"></a>
		  </div>
	</div>
	</s:iterator>
    </div>
    ...
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=-1">首页</a>
		</li>
		</s:if>
       <s:if test="#page.hasPrevious">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=<s:property value="#page.currentPage-1"/>&appTmp.isShelf=-1">上一页</a>
		</li>
		</s:if>
		<s:if test="#page.totalPage>1">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=-1">1</a></li>
       </s:if>
       <s:if test="#page.totalPage>2">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=2&appTmp.isShelf=-1">2</a></li>
        </s:if>
        <s:if test="#page.totalPage>3">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=3&appTmp.isShelf=-1">3</a></li>
        </s:if>
        <s:if test="#page.totalPage>4">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=4&appTmp.isShelf=-1">4</a></li>
       </s:if>
       <s:if test="#page.totalPage>5">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=5&appTmp.isShelf=-1">5</a></li>
       </s:if>
       <s:if test="#page.hasNext">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=<s:property value="#page.currentPage+1"/>&appTmp.isShelf=-1">下一页</a></li>
       </s:if>
       <s:if test="#page.hasLast">
		<li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=<s:property value="#page.totalPage"/>&appTmp.isShelf=-1">尾页</a></li>
		</s:if>
