...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         ...
         <li class="red"><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=0" target="main">待发布</a></li>
  ...
  <s:iterator value="#request['app']" id="app">
    ...
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=0">首页</a>
		</li>
		</s:if>
       <s:if test="#page.hasPrevious">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=<s:property value="#page.currentPage-1"/>&appTmp.isShelf=0">上一页</a>
		</li>
		</s:if>
		<s:if test="#page.totalPage>1">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=1&appTmp.isShelf=0">1</a></li>
       </s:if>
       <s:if test="#page.totalPage>2">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=2&appTmp.isShelf=0">2</a></li>
        </s:if>
        <s:if test="#page.totalPage>3">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=3&appTmp.isShelf=0">3</a></li>
        </s:if>
        <s:if test="#page.totalPage>4">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=4&appTmp.isShelf=0">4</a></li>
       </s:if>
       <s:if test="#page.totalPage>5">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=5&appTmp.isShelf=0">5</a></li>
       </s:if>
       <s:if test="#page.hasNext">
       <li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=<s:property value="#page.currentPage+1"/>&appTmp.isShelf=0">下一页</a></li>
       </s:if>
       <s:if test="#page.hasLast">
		<li><a href="devIsShelf.action?appTmp.isShelfCurrentPage=<s:property value="#page.totalPage&appTmp.isShelf=0"/>">尾页</a></li>
		</s:if>
