...
<div class="content">
     ...
     <div class="midcont">
                  <div class="list">
                      ...
                      %>
                          <form id="form1" name="form1" method="post" action="dev_consummate_sub.action" enctype="multipart/form-data" >
                          <!-- ********************************firstpage********************************** -->
...
<a href="#" class="bluea"> Logo样本</a>
                               ...
                               <div class="uppage"><input type="button" class="tijiao" value="×取消" onclick="javascript:history.back(-1);"><input type="submit" value="√保存" class="tijiao" id="id_submit"/></div>
                              </div>
                          </form>
