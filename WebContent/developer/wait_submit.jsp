...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         ...
         <li class="red"><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=1" target="main">等待提交</a></li>
   ...
   <div class="b2">
	...
	<div class="b3">
		 ...
		 <p><a href="dev_refer_shenhe.action?appId=<s:property value="#app.appInfo.id"/>" target="main">
...
<s:property value="#app.appInfo.appName" />
 ...
 <ul class="page">
       ...
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=1">首页</a>
		</li>
		</s:if>
       <s:if test="#page.hasPrevious">
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=<s:property value="#page.currentPage-1"/>">上一页</a>
		</li>
		</s:if>
		<s:if test="#page.totalPage>1">
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=1">1</a></li>
       </s:if>
       <s:if test="#page.totalPage>2">
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=2">2</a></li>
        </s:if>
        <s:if test="#page.totalPage>3">
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=3">3</a></li>
        </s:if>
        <s:if test="#page.totalPage>4">
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=4">4</a></li>
       </s:if>
       <s:if test="#page.totalPage>5">
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=5">5</a></li>
       </s:if>
       <s:if test="#page.hasNext">
       <li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=<s:property value="#page.currentPage+1"/>">下一页</a></li>
       </s:if>
       <s:if test="#page.hasLast">
		<li><a href="devIsThrough.action?appTmp.isThrough=-2&appTmp.isThroughCurrentPage=<s:property value="#page.totalPage"/>">尾页</a></li>
		</s:if>
