...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         <li><a href="devShowJoint.action?currentPage=1&shelf=1&joint=1" target="main">已上架</a></li>
         <li><a href="devShowJoint.action?currentPage=1&shelf=0&joint=1" target="main">待发布</a></li>
         <li class="red"><a href="devShowJoint.action?currentPage=-1&shelf=1&joint=1" target="main">已下架</a></li>
      </ul>
   <div class="b2">
