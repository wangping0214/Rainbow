...
<frameset cols="*,990,*" borer="0" id="frame_main" framespacing="0" scrolling="no" frameborder="0"   >  
   ...
   <frameset cols="170,*"  framespacing="0" border="0" frameborder="0"  > 
      ...
      <frame src="<%=request.getContextPath()%>/developer/main3.jsp" name="main" noresize="noresize" scrolling="no"  border="0"  framespacing="0" frameborder="0"   />
   </frameset>
