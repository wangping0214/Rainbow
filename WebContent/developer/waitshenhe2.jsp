...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         <li class="red"><a href="devIsThrough.action?appTmp.isThrough=0" target="main">等待审核</a></li>
         <li><a href="devIsThrough.action?appTmp.isThrough=-1" target="main">未通过审核</a></li>
      </ul>
