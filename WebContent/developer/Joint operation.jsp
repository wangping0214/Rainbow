...
.twobut{ background:url(images/daits.png) no-repeat; width:110px; height:30px; margin-top:5px;}
...
<script language="javascript" type="text/javascript">
	function shelfManage(appName,apkId,shelf){
		if(window.confirm("将"+appName+"下架？")){
			jQuery.ajax({
				type : "post",
...
<div class="content">
   ...
   <div class="midcont">
      <ul class="shenhenav">
         <li class="red"><a href="devShowJoint.action?currentPage=1&shelf=1&joint=1" target="main">已上架</a></li>
         <li><a href="devShowJoint.action?currentPage=1&shelf=0&joint=1" target="main">待发布</a></li>
         <li><a href="devShowJoint.action?currentPage=1&shelf=-1&joint=1" target="main">已下架</a></li>
      </ul>
   <div class="b2">
...
<s:property value="#app.appInfo.appName" />
    ...
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="devShowJoint.action?currentPage=1&shelf=1&joint=1">首页</a>
		</li>
		</s:if>
       <s:if test="#page.hasPrevious">
       <li><a href="devShowJoint.action?currentPage=<s:property value="#page.currentPage-1"/>&shelf=1&joint=1">上一页</a>
		</li>
		</s:if>
		<s:if test="#page.totalPage>1">
       <li><a href="devShowJoint.action?currentPage=1&shelf=1&joint=1">1</a></li>
       </s:if>
       <s:if test="#page.totalPage>2">
       <li><a href="devShowJoint.action?currentPage=2&shelf=1&joint=1">2</a></li>
        </s:if>
        <s:if test="#page.totalPage>3">
       <li><a href="devShowJoint.action?currentPage=3&shelf=1&joint=1">3</a></li>
        </s:if>
        <s:if test="#page.totalPage>4">
       <li><a href="devShowJoint.action?currentPage=4&shelf=1&joint=1">4</a></li>
       </s:if>
       <s:if test="#page.totalPage>5">
       <li><a href="devShowJoint.action?currentPage=5&shelf=1&joint=1">5</a></li>
       </s:if>
       <s:if test="#page.hasNext">
       <li><a href="devShowJoint.action?currentPage=<s:property value="#page.currentPage+1"/>&shelf=1&joint=1">下一页</a></li>
       </s:if>
       <s:if test="#page.hasLast">
		<li><a href="devShowJoint.action?currentPage=<s:property value="#page.totalPage"/>&shelf=1&joint=1">尾页</a></li>
		</s:if>
