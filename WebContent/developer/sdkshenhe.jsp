<%@ page language="java" import="com.rainbow.entity.AppInfo" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
     ...
     <div class="midcont">
                   <div class="list">
                      <h3 class="tit2">选择发布类型</h3>
                        <div class="sdkfabu">
                        <form id="form" name="form" method="post" action="guanlishenhe.jsp" enctype="multipart/form-data">
                            <div>
                                <p class="size20"><input type="radio" name="joint" <%if(info.getJoint()==0){ %> checked="checked"<%} %> value="0" />应用推广</p>
                                <p class="sdkcont">如果您的应用已经开发完成，并希望能在柴米游戏平台上展示该作品。您此时只需要按照我们的发布流程填写应用的相关信息。上传APP及相关蔬菜提交就可以了。
</p>
                            </div>
                            <div>
                                <p class="size20"><input type="radio" name="joint" <%if(info.getJoint()==1){ %> checked="checked"<%} %> value="1" />联运发布（已集成柴米游戏SDK）</p>
