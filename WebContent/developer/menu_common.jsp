...
<ul id="menu">
 <li class="item"><a class="title nav2" name="1" target="main">应用&amp;游戏</a>
   <ul id="opt_1" class="optiton">
   	<li><a target="main"><img src="images/ID.gif" />ID 信息</a></li>
    <li><a target="main"><img src="images/lianyun.gif" />联运应用管理</a></li>
    <li><a target="main"><img src="images/img16.gif" />管理游戏&amp;应用</a></li>
    <li><a target="main"><img src="images/img17.gif"/>添加新应用</a></li>
    <li class="gl"><a target="main"><img src="images/img18.gif"/>审核管理</a></li>
    <li><a target="main"><img src="images/img29.gif" />统计列表</a></li>

   </ul>
 </li>
 <li class="item"><a href="javascript:void(0);" target="main" class="title nav3" name="2">开发者信息</a>
   <ul id="opt_2" class="optiton">
	<li><a target="main"><img src="images/img28.gif" />广告位申请</a></li>
    <li><a target="main"><img src="images/img30.gif" />开发者信息</a></li>
    <li><a target="main"><img src="images/mm.gif" />修改密码</a></li>
    <li><a target="main"><img src="images/xiao.gif" />消息管理</a></li>
   </ul>
 </li>
</ul> 
<ul class="yonghu">
 ...
 <div class="message">
     <a  target="main"><img src="images/email.png" /></a>
 </div>
 <!--message-->
</div>
