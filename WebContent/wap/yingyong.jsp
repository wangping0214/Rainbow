...
<table width="320" height="29" border="0">
  <tr>
    ...
    <td width="45"><div class="circle"><a href="showByType.action?appTmp.showByTypeCurrentPage=1&type=2"><font color="#fff">应用</font></a></div></td>
...
<ul class="page">
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="showByType.action?appTmp.showByTypeCurrentPage=<s:property value="#page.currentPage-1"/>&type=2">上一页</a>
		</li>
		</s:if>
       <s:if test="#page.hasNext">
       <li><a href="showByType.action?appTmp.showByTypeCurrentPage=<s:property value="#page.currentPage+1"/>&type=2">下一页</a></li>
       </s:if>
     </ul>
     </div>
