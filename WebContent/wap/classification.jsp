...
<ul class="page">
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="showByClassification.action?appTmp.showByClassificationCurrentPage=<s:property value="#page.currentPage-1"/>&classification=<s:property value="#request.classification"/>">上一页</a>
		</li>
		</s:if>
       <s:if test="#page.hasNext">
       <li><a href="showByClassification.action?appTmp.showByClassificationCurrentPage=<s:property value="#page.currentPage+1"/>&classification=<s:property value="#request.classification"/>">下一页</a></li>
       </s:if>
     </ul>
     </div>
 <div class="fc3q">
