...
<ul class="page">
    <s:set name="page" value="#request.page"/>
       ...
       <li><a href="showByType.action?appTmp.showByTypeCurrentPage=<s:property value="#page.currentPage-1"/>&type=1">上一页</a>
		</li>
		</s:if>
       <s:if test="#page.hasNext">
       <li><a href="showByType.action?appTmp.showByTypeCurrentPage=<s:property value="#page.currentPage+1"/>&type=1">下一页</a></li>
       </s:if>
     </ul>
     </div>
